...
export const tipList = {
  name: '팁 리스트',
  tip: ['조리도구 관리', '가전제품 기본', '가전제품 관리'],
  body: [
    ['11', '11', '11f'],
    [
      ['[기본 주의사항]', '❗️열, 불, 화학물질, 먼지'],
      [
        ['1,2,3', 'a', 'b'],
        ['155', 'a', 'b'],
      ],
    ...
    // '젖은 손으로 제품/부품을 만지지 않는다.',
    // '⭐️ 금속',
    // '감전 위험이 있다.',
    // '금속성 물질을 제품 내에 넣지 않도록 한다. 전원코드 및 플러그의 피복이 눌리지 않게 한다. 전원을 뽑을 때 전선이 아닌 플러그를 잡고 뽑도록 한다.',
    // '⚡️ 전기',
    // '정해진 전압, 전류에서만 사용한다. 제품의 용도에 맞게 사용한다 (가정용 제품을 다른 용도로 사용하면 환경에 따라 감전, 화재가 일어날 수 있다).',
  ...
  //   '',
  //   '[설치 장소]',
  //   '(금지) 습기가 많은 곳, 화학약품, 화기가 있는 곳',
  //   '(권장) 바닥이 튼튼하고 수평인 곳, 코드를 빼기 쉬운 곳',
  //   '- 직사광선이 쬐는 곳, 가스레인지, 라이터, 전열기구, 풍로, 물이 닿을 수 있는 환경 등 위와 가까운 환경에서 사용하지 않는다.',
  ...
  //   '전용 콘센트를 사용하고 (220V) 연장 콘센트 사용시 접지가 있는 연장 콘센트를 사용한다.',
